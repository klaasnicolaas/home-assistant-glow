...
<p align="left">
  <img width="60%" src={require('@site/static/img/my-link.png').default} />
</p>
...
1. Within your Home Assistant instance go to **Configuration** > **Integrations** (see image below).
2. Click on **Configure**, at the discovered Home Assistant Glow.
3. It asks if you want to add the device and click **Submit**.
4. Congratulations 🎉 You have successfully added the Home Assistant Glow to your Home Assistant instance.

<p align="left">
  <img width="40%" src={require('@site/static/img/auto-discovery.png').default} />
</p>
