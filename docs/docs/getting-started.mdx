...
To get started you need the right hardware first, fill your 🛒 or see if you already have the components in house. Choose one of the listed microcontrollers, but keep in mind that the ESP32 is recommended.
...
Affiliate links are used on this website to support the Home Assistant Glow 🌟 project. Some Ad-blockers might block these links an thus they seem to appear broken. You will have to temporarily disable ad-blocker to open these links.
