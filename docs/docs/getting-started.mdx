...
## <span style={{backgroundColor: 'var(--ifm-color-primary)', color: 'white', padding: '0.25rem 0.75rem', borderRadius: '999px', marginRight: '0.5rem', fontSize: '0.9em'}}>Step 1</span> Hardware

To get started, you need the right hardware first, fill your 🛒 or see if you already have the items in house. Choose between an **ESP32** (recommended), **ESP32-C3**, or **ESP8266**.

| Nr. | Item | Where to buy |
|:----|:-----|:-------------|
|**1.**| ESP32 (recommended) | [AliExpress](https://s.click.aliexpress.com/e/_DdAe4Fl) \| [AliExpress][esp32-ali-shop] \| [Banggood][esp32-bg-shop] |
|**1.**| ESP32-C3 | [AliExpress](https://s.click.aliexpress.com/e/_c33qKQuJ) \| [AliExpress][esp32c3-ali-shop] |
...
## <span style={{backgroundColor: 'var(--ifm-color-primary)', color: 'white', padding: '0.25rem 0.75rem', borderRadius: '999px', marginRight: '0.5rem', fontSize: '0.9em'}}>Step 2</span> Install firmware
...
1. Choose your firmware variant below (Standard or Basic) and click the blue **Connect** button to display a list of available USB devices.
...
## <span style={{backgroundColor: 'var(--ifm-color-primary)', color: 'white', padding: '0.25rem 0.75rem', borderRadius: '999px', marginRight: '0.5rem', fontSize: '0.9em'}}>Step 3</span> Connect to Home Assistant
...
<Tabs>
  <TabItem value="during-install" label="During firmware installation" default>
...
<p align="left">
  ...
  <TabItem value="auto-discovery" label="Auto discovery">
...
:::note
If you're prompted for an encryption key when adding the device, this means you may have accidentally adopted it in ESPHome Builder. The default firmware does not require an encryption key. See [FAQ: Encryption Key Required](/docs/faq/encryption_key_required) for more information.
:::

## <span style={{backgroundColor: 'var(--ifm-color-primary)', color: 'white', padding: '0.25rem 0.75rem', borderRadius: '999px', marginRight: '0.5rem', fontSize: '0.9em'}}>Step 4</span> Configure the Pulse Rate
...
## <span style={{backgroundColor: 'var(--ifm-color-primary)', color: 'white', padding: '0.25rem 0.75rem', borderRadius: '999px', marginRight: '0.5rem', fontSize: '0.9em'}}>Step 5</span> Print the case
...
## <span style={{backgroundColor: 'var(--ifm-color-primary)', color: 'white', padding: '0.25rem 0.75rem', borderRadius: '999px', marginRight: '0.5rem', fontSize: '0.9em'}}>Step 6</span> Sit back and relax
...
[dupont-jumpers-bg-shop]: https://www.banggood.com/bang/?tt=16956_12_417111_&r=https%3A%2F%2Fwww.banggood.com%2Fnl%2F120pcs-40PIN-20CM-Dupont-Line-Male-to-Male-%2B-Male-to-Female-%2B-Female-to-Female-Jumper-Dupont-Wire-Cable-for-DIY-KIT-p-1817209.html
