...
:::note
Keep in mind that besides the photodiode board there are also boards in circulation with an LDR. The expension board is optional, but makes it easier to connect and prototype with the components.
:::
