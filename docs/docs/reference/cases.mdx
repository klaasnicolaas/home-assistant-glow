...
If you are familiar with OnShape, you can find the model by searching for \"home-assistant-glow esp32-wroom-case\" where you can make a copy and modify it to your specifications.
