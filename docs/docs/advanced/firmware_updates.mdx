...
:::note
Since ESPHome 2024.6.x, the update component can directly retrieve firmware updates from the [glow-energy.io](https://glow-energy.io) manifest. Which has made updating even easier and eliminates the need to use ESPHome Builder (app) just for updates.
:::
...
1. Download the latest firmware binary file for your device:
    ...
    **Which variant do you need?**
    ...
    Choose the variant that matches your hardware setup:

    - **Standard** - For the complete Home Assistant Glow with RGB LED (recommended for most users)
    - **Basic** - For minimal builds without LED hardware (only pulse sensor connected)

    | Device | Standard | Basic |
    |--------|---------|-------|
    | **ESP32** | [Download](https://glow-energy.io/home-assistant-glow/esp32/home-assistant-glow-esp32.ota.bin) | [Download](https://glow-energy.io/glow-basic/esp32/glow-basic-esp32.ota.bin) |
    | **ESP32-C3** | [Download](https://glow-energy.io/home-assistant-glow/esp32c3/home-assistant-glow-esp32c3.ota.bin) | [Download](https://glow-energy.io/glow-basic/esp32c3/glow-basic-esp32c3.ota.bin) |
    | **ESP8266** | [Download](https://glow-energy.io/home-assistant-glow/esp8266/home-assistant-glow-esp8266.ota.bin) | [Download](https://glow-energy.io/glow-basic/esp8266/glow-basic-esp8266.ota.bin) |
...
If you are using the ESPHome Builder app in Home Assistant, you can also update the firmware through the dashboard. This method is useful if you have adopted the firmware to your ESPHome Builder and know how to tweak the YAML configuration.

:::warning
Once you adopt a device in ESPHome Builder, you will no longer receive automatic firmware updates from [glow-energy.io](https://glow-energy.io). You will need to manage all firmware updates yourself through ESPHome Builder.
:::

1. Open the ESPHome Builder (app).
...
<p align="left">
  <img 
    ...
    alt="Update firmware through ESPHome Builder (app)"
  />
</p>