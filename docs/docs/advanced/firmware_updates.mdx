...
description: Learn how to update the firmware of the Home Assistant Glow.
---
...
2. If it is possible to update the firmware, you will see a update button at the device card (see image below).
