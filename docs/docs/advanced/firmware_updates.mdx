...
:::note
Since ESPHome 2024.6.x, the update component can directly retrieve firmware updates from the [glow-energy.io](https://glow-energy.io) manifest. Which has made updating even easier and eliminates the need to use ESPHome Dashboard (add-on) just for updates.
:::
...
1. Open the ESPHome Dashboard (add-on).
...
<p align="left">
  <img 
    ...
    alt="Update firmware through ESPHome Dashboard (add-on)"
  />
</p>