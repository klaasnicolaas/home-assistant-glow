...
Following the **Take Control** steps will automatically:
...
:::warning
Adopting the device in ESPHome Dashboard will replace the stock firmware with a custom version managed by ESPHome. This means you will no longer receive automatic firmware updates from [glow-energy.io](https://glow-energy.io). You will need to manage updates through ESPHome going forward.
:::
